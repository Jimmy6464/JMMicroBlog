...
-(void)setMessageBase:(FWBMessage *)messageBase
{
    ...
    //用户名
    _userName.text=[messageBase.user objectForKey:@"name"];
    ...
    //内容
    _text.attributedText = [NSMutableAttributedString changeTextAttributed:messageBase.text withFontSize:20];
    ...
    //时间
    _created_at.text=messageBase.created_at;
    ...
    //设备
    NSArray *stringArr=[messageBase.source componentsSeparatedByString:@">"];
